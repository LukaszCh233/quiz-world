...
public class MapEntity {
    ...
    public com.example.quiz_world.dto.QuizDTO mapQuizToQuizDTO(Quiz quiz) {
        return new com.example.quiz_world.dto.QuizDTO(quiz.getId(), quiz.getTitle(), quiz.getQuizCategory().getName());
    }
